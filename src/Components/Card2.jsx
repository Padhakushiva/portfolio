    ...
    >
      ...
      <div className="text-center md:text-left">
        ...
        <p className="text-xs md:text-sm lg:text-base xl:text-lg leading-relaxed md:leading-relaxed lg:leading-loose text-white/75 mb-4 md:mb-5 lg:mb-6">
          TaskFlow is a collaborative web app that helps teams plan sprints, assign tasks, and track progress in one place. It includes live status updates, searchable task boards, and secure data storage, delivering a fast and responsive experience from desktop to mobile.
        </p>
