...
export default function Contact({
  ...
  // Contact section animation logic (same as Footer)
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Calculate if we're within 30% from bottom (same as Footer logic)
      const thirtyPercentFromBottom = documentHeight - windowHeight * 1.3;
      
      if (scrollY >= thirtyPercentFromBottom) {
        // Trigger all contact animations when 30% from bottom
        const contactElements = contact.querySelectorAll(
          '.smooth-section, .section-divider, .hero-text-effect, .text-reveal, .stagger-animation, .image-reveal'
        );
        
        contactElements.forEach((element, index) => {
          const elementId = element.dataset.contactId || `contact-${index}`;
          element.dataset.contactId = elementId;
...
`;
  ...
  return (
    <div
      ...
      className={`w-full min-h-screen relative overflow-hidden smooth-section bg-gray-900 ${
        className || ""
      }`}
      style={style}
    >
      {/* Fluid animation background renders here */}
      
      {/* Contact Content Container */}
      <div className="absolute inset-0 flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12 z-10">
        
        {/* Header Section */}
        <div className="text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20 max-w-4xl mx-auto section-divider">
          
          {/* Title */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-4 sm:mb-6 md:mb-8 hero-text-effect animate-gradient-projects bg-gradient-to-r from-blue-500 via-purple-500 to-pink-400 bg-clip-text text-transparent bg-size-400">
            Get In Touch
          </h1>
          
          {/* Description */}
          <p className="text-white/90 text-center max-w-2xl mx-auto text-lg sm:text-xl md:text-2xl lg:text-3xl leading-relaxed text-reveal">
        ...
        <div className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl pointer-events-auto">
          <form className="bg-gray-900/90 backdrop-blur-lg rounded-xl sm:rounded-2xl border border-gray-600/40 shadow-2xl p-6 sm:p-8 md:p-10 lg:p-12 space-y-6 smooth-section">
            ...
            <div className="stagger-animation">
              ...
              <textarea 
                ...
                className="w-full px-4 py-3 sm:px-5 sm:py-4 md:px-6 md:py-5
                           ...
                           focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500
                           transition-all duration-300 hover:bg-white hover:shadow-md
                           focus:scale-[1.02] sm:rows-5 md:rows-6"
              ></textarea>
            </div>
            ...
            <div className="pt-4 image-reveal">
              <button 
                type="submit"
                className="group relative w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-500 hover:via-purple-500 hover:to-pink-500 text-white font-bold 
